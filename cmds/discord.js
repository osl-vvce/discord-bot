...
module.exports.run = async (client, message, args) => {
  ...
  let embed3 = new Discord.RichEmbed()
    ...
    .setColor("#075eea")
    .setDescription(
      "Discord has some built in styling options known as markdown. One that you might find the most useful is code blocks using back ticks."
    )
    ...
    .addField(
      "Codeblocks",
      "Using backticks as shown below you can create codeblocks."
    )
    .setImage(
      "https://support.discordapp.com/hc/en-us/article_attachments/211601448/HelloWorldForm.png"
    );
  ...
  const embed = new Discord.RichEmbed()
    ...
    .setColor(0x00ae86)
    .setDescription(
      "Getting started with voice chat, click the image below for a larger view."
    )
    .setImage(
      "https://cdn.discordapp.com/attachments/435949792389234690/440117418824826890/voice.png"
    )
    .addField(
...
module.exports.help = {
  name: "discord",
  descr: "Guides you how to use discord"
};
